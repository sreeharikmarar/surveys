...
function showPopUpWindow(options){
    ...
    //        $('#DIVID_LIGHT_BOX_CONTAINER').css("margin-top","50px");
    //        $('#DIVID_LIGHT_BOX_CONTAINER_MAIN').css("margin-top","0px");
    } else {
        $("#DIVID_LIGHT_BOX_HEADER").hide();
    //        $('#DIVID_LIGHT_BOX_CONTAINER').css("margin-top","-50px");
    //        $('#DIVID_LIGHT_BOX_CONTAINER_MAIN').css("margin-top","50px");
    }
